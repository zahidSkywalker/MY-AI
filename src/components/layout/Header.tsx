        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
              ...
              <div className="flex-shrink-0">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="hidden sm:block">
                    <div className="text-xl font-bold text-gray-900">BanglaFashion</div>
                    <div className="text-xs text-gray-500">বাংলা ফ্যাশন</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <nav className="hidden lg:flex space-x-8">
              {navigation.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-gray-700 hover:text-primary-600 px-3 py-2 text-sm font-medium transition-colors duration-200 group"
                >
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Wishlist */}
              <button className="p-2 text-gray-700 hover:text-primary-600 transition-colors duration-200 relative">
              ...
              <button
                ...
                className="p-2 text-gray-700 hover:text-primary-600 transition-colors duration-200 relative"
              >
